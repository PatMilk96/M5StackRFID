...
class UHF_RFID
{
  ...
  public:
    ...
    void ToHex(UDOUBLE parameters, UBYTE MSB, UBYTE LSB);
    ...
    CardInformationInfo Read_the_label_data_store(UDOUBLE Access_Password, UBYTE MemBank, UWORD SA, UWORD DL);
    CardInformationInfo The_label_store_writes_data(UDOUBLE Access_Password , UBYTE MemBank, UWORD SA, UWORD DL, UDOUBLE DT);
    CardInformationInfo Lock_the_label_data_store(UDOUBLE Access_Password, UBYTE Action_nub, UBYTE Action);
    ...
    CardInformationInfo BlockPermalock(UDOUBLE Access_Password, UBYTE Read_Lock = 0x00, UBYTE MemBank = 0x02, UWORD BlockPtr = 0x00, UBYTE BlockRange = 0x01, UWORD Mask = 0x0700);
